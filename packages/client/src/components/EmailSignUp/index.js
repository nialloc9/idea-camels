...
export default class EmailSignUp extends Component {
    ...
    get messageProps() {
        ...
        const message = isSuccess ? "Thank you very much. We will be in contact soon." : "Please try again.";
    ...
    handleClick = async () => {
        ...
        try {
            ...
            await post("https://z68olw9sk5.execute-api.eu-west-1.amazonaws.com/prod/coming-soon", {email});
    ...
    renderMessage = () => {
        ...
        return <Message positive={positive} negative={negative}>{message}</Message>
    }
