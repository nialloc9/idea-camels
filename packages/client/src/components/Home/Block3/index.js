    ...
    <Container>
        <Overlay>
            <TextContainer>
                ...
                <MainText>
                    Combining a super modern UI with paid search to create a
                    landing page and drive traffic to it based on other internet
                    users search keywords. Don't spend time creating a fully
                    fleged site when all you want to know is it worth the
                    development time. Instead you can know in a matter of days
                    if your new idea is worth persuing.
                </MainText>
                <ButtonContainer>
                    <AnalyticsButton
                        href="/coming-soon"
