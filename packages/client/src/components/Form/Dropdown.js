...
export class Dropdown extends Component {
    ...
    render() {
        const { label, info, error, customError, errorColored = false, warn, touched, ...rest } = this.props;
        ...
        return (
            <Form.Field>
                ...
                <StyledDropdown error={formError && formTouched} {...rest} onChange={this.handleChange}  />
