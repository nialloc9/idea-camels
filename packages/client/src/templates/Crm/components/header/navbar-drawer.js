...
const NavbarDrawer = ({ isSticky, config, content }) => {
  ...
  return (
    <Drawer
      ...
      closeButton={
        <button sx={styles.closeButton}>
          <Image
            src={
              "https://prod-themes.s3.eu-west-1.amazonaws.com/template_2/icons/close.png"
            }
            alt="close"
          />
        </button>
    ...
    >
      <Box sx={styles.wrapper}>
        <Logo content={content} config={config} sx={styles.logo} dark />
