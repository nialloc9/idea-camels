    ...
    <Section minHeight="100vh" justifyContent="center" display="flex">
      <Block display="flex" justifyContent="center" flexDirection="column">
        <Segment>
          ...
          <p>Welcome to IdeaCamels!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of ideacamels.com's Website, located at https://ideacamels.com/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use IdeaCamels if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing IdeaCamels, you agreed to
            use cookies in agreement with the ideacamels.com's Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, ideacamels.com and/or its licensors own the
            intellectual property rights for all material on IdeaCamels. All
            intellectual property rights are reserved. You may access this from
            IdeaCamels for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from IdeaCamels</li>
            <li>Sell, rent or sub-license material from IdeaCamels</li>
            <li>Reproduce, duplicate or copy material from IdeaCamels</li>
            <li>Redistribute content from IdeaCamels</li>
          </ul>
          ...
          <p>
            ...
            ideacamels.com does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of ideacamels.com,its agents and/or affiliates.
            ...
            ideacamels.com shall not be liable for the Comments or for any
          ...
          <p>
            ideacamels.com reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant ideacamels.com a non-exclusive license to use,
          ...
          <p>
            ...
            ideacamels.com; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to ideacamels.com. Please include your name, your
          ...
          <p>
            No use of ideacamels.com's logo or other artwork will be allowed for
