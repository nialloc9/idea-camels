...
export const Block = styled.div`
  ...
  ${({ wordBreak = false }) => wordBreak && `word-break: ${wordBreak};`}
    ...
    ${({ overflowX = false }) => overflowX && `overflow-x: ${overflowX};`}
    ${({ overflowY = false }) => overflowY && `overflow-y: ${overflowY};`}
    ...
    ${({ boxShadow = false }) => boxShadow && `box-shadow: ${boxShadow};`}
    ${({ zIndex = false }) => zIndex && `z-index: ${zIndex};`}
    ...
    ${({ alignItems = false }) => alignItems && `align-items: ${alignItems};`}
    ${({ wordBreak = false }) => wordBreak && `word-break: ${wordBreak};`}
    
    ${({ theme: { breakpoints } }) => createMediaQuery(breakpoints.tablet)} {
    ${({ tabletBackground = false }) =>
      tabletBackground && `background: ${tabletBackground};`}
    ${({ tabletHeight = false }) => tabletHeight && `height: ${tabletHeight};`}
        ${({ tabletWidth = false }) => tabletWidth && `width: ${tabletWidth};`}
  ...
  ${({ theme: { breakpoints } }) => createMediaQuery(breakpoints.computer)} {
    ...
    ${({ computerBackground = false }) =>
      computerBackground && `background: ${computerBackground};`}
      ...
      computerMinHeight && `min-height: ${computerMinHeight};`}
  ...
  ${({ theme: { breakpoints } }) =>
    ...
    ${({ computerLargeBackground = false }) =>
      computerLargeBackground && `background: ${computerLargeBackground};`}
    ${({ computerLargeHeight = false }) =>
      computerLargeHeight && `height: ${computerLargeHeight};`}
  ...
  ::-webkit-scrollbar {
    ...
    ${({ scrollBackgroundColor = false }) =>
      scrollBackgroundColor && `background-color: ${scrollBackgroundColor};`}
